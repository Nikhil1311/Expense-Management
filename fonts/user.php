...
function get_activity_group_add()
{
	...
	$sql = "SELECT grouptable.emailId AS 'CreatedBy',user.firstName, grouptable.groupName,usergroups.emailId,usergroups.groupId, grouptable.timestamp FROM usergroups LEFT JOIN grouptable ON usergroups.groupId = grouptable.groupId,user where usergroups.emailId = 'user1@gmail.com' AND user.emailId = grouptable.emailId ORDER BY timestamp DESC";
...
function get_activity_payments()
{
	...
	$sql = "SELECT *  FROM payment where emailIdPaid = 'user1@gmail.com' OR emailIdPayee = 'user1@gmail.com' ORDER BY timestamp DESC";
