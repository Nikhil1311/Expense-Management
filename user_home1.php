...
<html lang="en">
  <head>
    ...
    function update_amt()
    {
		...
		amounts["groupid"]=String(data.id[0])
             ...
             for(var i=0;i<data.mail.length;i++)
                {
                    ...
                    names_div.insertBefore(para,names_div.childNodes[0])
                   // break_line = document.createElement("br");
                }
        }
    }
        ...
        <div class="col-md-12">
            ...
            <center><p class = "logintext2">Provide Details</p></center>
                ...
                <div class="col-md-8">
                    <div class="addbutton">
                        <div class="input-container">
                                <input type="#{type}" id="#{label}" class="paidby" name = "description" required="required"/>
                                <label for="#{label}">Amount Paid By</label>
                                <div class="bar"></div>
                        </div>
                    ...
                    <div class="col-md-8" style = "margin-top:10px">
                        <a data-toggle="modal" data-target="#grpModalexp" data-dismiss="modal"><button type="button" class="btn btn-success btn-lg">Back</button></a>
